...
helpers.and = function () {
  ...
  return utils_hb.value(val, this, options)
}
...
helpers.compare = function (a, operator, b, options) {
  ...
  return utils_hb.value(result, this, options)
}
...
helpers.contains = function (collection, value, startIndex, options) {
  ...
  let val = utils.contains(collection, value, startIndex)
  return utils_hb.value(val, this, options)
}
...
helpers.eq = function (a, b, options) {
  ...
  return utils_hb.value(a === b, this, options)
}
...
helpers.has = function (value, pattern, options) {
  if (utils_hb.isOptions(value)) {
    options = value
    pattern = null
    value = null
  }

  if (utils_hb.isOptions(pattern)) {
    options = pattern
    pattern = null
  }

  if (value === null) {
    return utils_hb.value(false, this, options)
  }

  if (arguments.length === 2) {
    return utils_hb.value(utils.has(this, value), this, options)
  }

  if (
    (Array.isArray(value) || utils.isString(value)) &&
    utils.isString(pattern)
  ) {
    if (value.indexOf(pattern) > -1) {
      return utils_hb.fn(true, this, options)
    }
  }
  if (utils.isObject(value) && utils.isString(pattern) && pattern in value) {
    return utils_hb.fn(true, this, options)
  }
  return utils_hb.inverse(false, this, options)
}
...
helpers.isFalsey = function (val, options) {
  return utils_hb.value(utils.falsey(val), this, options)
}
...
helpers.ifEven = function (num, options) {
  return utils_hb.value(utils.isEven(num), this, options)
}
...
helpers.ifNth = function (a, b, options) {
  let isNth = utils.isNumber(a) && utils.isNumber(b) && b % a === 0
  return utils_hb.value(isNth, this, options)
}
...
helpers.ifOdd = function (val, options) {
  return utils_hb.value(!utils.isEven(val), this, options)
}
